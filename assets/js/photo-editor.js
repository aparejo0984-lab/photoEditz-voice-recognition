...
function confirmImage(){
    ...
    GlobalImage.onload = function(){
        ...
        ctx.drawImage(GlobalImage,0,0,GlobalImage.naturalWidth  / fit , GlobalImage.naturalHeight / fit );
    }
...
function downloadImage(){
    image_name = $("#image_filename").val().length > 0 ? $("#image_filename").val() : global_image_filename;
    image_format = $("#image_format").val().length > 0 ? $("#image_format").val() : global_image_format;
...
$(document).ready(function(){
    $(document).on("change","#Inputimage",function(e){
        ...
        if($("#Inputimage").val() != "" || $("#Inputimage").val() != null || $("#Inputimage").val() != undefined){
